...
【重要ルール】
- ユーザーの回答に含まれる情報のみに基づいて判断してください。回答されていない項目について推測や仮定をしないでください。
- 例: クレカの質問で「楽天カード」と回答した場合、「他にゴールドカードを持っていない」と決めつけないでください。
- 推奨アクションは、回答内容から明確に改善余地があると判断できるものだけを提示してください。
- 「〜を持っていないなら」「〜をやっていないなら」のような条件付きの提案は避け、回答から確実に言えることだけを述べてください。
